...
*The resulting cross-sections generated by the generator after sampling the random variables for the initial noise seed from a Cauchy Distribution*
![Figure 7](figures/noise2.png?raw=true)
*The resulting cross-sections generated by the generator after sampling the random variables for the initial noise seed from a Laplace Distribution*
![Figure 7](figures/noise3.png?raw=true)
*The resulting cross-sections generated by the generator after sampling the random variables for the initial noise seed from a Uniform Distribution*
![Figure 7](figures/noise4.png?raw=true)
*The resulting cross-sections generated by the generator after sampling the random variables for the initial noise seed from a Exponential Distribution*
